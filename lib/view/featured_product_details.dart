...
//
// class FeaturedProductDetailScreen extends StatelessWidget {
...
//
//   FeaturedProductDetailScreen({@required this.product}) {
...
//                                 left: 10,
//                                 child: IconButton(
//                                   icon: Icon(wishListController.items.any((element) => element.id==product.id)? Icons.favorite: Icons.favorite_border,
...
//                                         Row(
//                                           children: [
//                                             productDetailScreenController.product.value.discountedPrice == productDetailScreenController.product.value.salePrice?
//                                             Text(
//                                                 '\$${productDetailScreenController.product.value.salePrice}',
//                                                 style: TextStyle(
//                                                     color: AppColors.primaryColor,
//                                                     fontWeight: FontWeight.bold ,
//                                                     fontSize: 14,
...
//
//                                             Text(
//                                               '  \$${productDetailScreenController.product.value.discountedPrice}',
//                                               style: TextStyle(
//                                                 fontSize: 15,
//                                                 color: AppColors.primaryColor,
// //
...
//                                     return Row(
//                                       children:
//                                       product.choices.length == 0 ? Container() :
...
//                                 crossAxisAlignment: CrossAxisAlignment.start,
//                                 children: [
//                                   Text('Product Info', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18),),
//                                   SizedBox(height: MediaQuery.of(context).size.height*0.008,),
//                                   Text('Features:', style: TextStyle(fontSize: 18)),
//                                   Html(data: product.shortDetails),
//                                 ],
//                               ),
//                               Divider(),
//                               Column(
...
//                                             .map((size) => Text('${size.title}, ', style: TextStyle(fontSize: 18),)).toList()
//                                     ),
//                                   ),
//                                 ],
//                               ),
